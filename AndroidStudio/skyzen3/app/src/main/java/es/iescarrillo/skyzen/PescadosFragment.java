// es.iescarrillo.skyzen.PescadosFragment.java
...
public class PescadosFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.tabCarnes).setOnClickListener(v ->
                NavHostFragment.findNavController(PescadosFragment.this)
        ...
        setupItemClick(view, R.id.itemSalmón, "Salmón");
        setupItemClick(view, R.id.itemBacalao, "Bacalao");
        setupItemClick(view, R.id.itemMerluza, "Merluza");
        setupItemClick(view, R.id.itemAtún, "Atún");
        setupItemClick(view, R.id.itemDorada, "Dorada");
        setupItemClick(view, R.id.itemSepia, "Sepia");
    }
